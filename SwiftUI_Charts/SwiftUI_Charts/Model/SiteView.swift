...
var sample_analytics: [SiteView] = [
    ...
    SiteView(hour: Date().updateHour(value: 17) ,views: 5866),
    SiteView(hour: Date().updateHour(value: 18) ,views: 3578),
    SiteView(hour: Date().updateHour(value: 19) ,views: 4289),
    SiteView(hour: Date().updateHour(value: 20) ,views: 2547)
]
